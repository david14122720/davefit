        ...
        <div className="max-w-6xl mx-auto">
            ...
            <div className="relative mb-6">
                ...
                <input
                    ...
                    className="w-full pl-12 pr-4 py-3 bg-[#141414] border border-white/5 rounded-xl text-white placeholder-gray-500 focus:outline-hidden focus:border-primary/50 transition-colors"
                />
            </div>
            ...
            <div className="md:hidden space-y-3">
                {filteredEjercicios.map((e) => (
                    <div key={e.id} className="bg-[#141414] rounded-2xl border border-white/5 p-4 flex items-center gap-4">
                        {e.imagen_url ? (
                            <img src={e.imagen_url} alt={e.nombre} className="w-14 h-14 rounded-xl object-cover border border-white/10 shrink-0" />
                        ) : (
                            <div className="w-14 h-14 rounded-xl bg-primary/10 flex items-center justify-center text-2xl border border-primary/20 shrink-0">
                                {grupoIcons[e.grupo_muscular] || '💪'}
                            </div>
                        )}
                        ...
                        <form onSubmit={handleSubmit} className="p-6 space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-3 bg-[#0a0a0a] border border-white/10 rounded-xl text-white focus:outline-hidden focus:border-primary/50"
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    className="w-full px-4 py-3 bg-[#0a0a0a] border border-white/10 rounded-xl text-white focus:outline-hidden focus:border-primary/50 resize-none"
                                    rows={2}
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className="w-full pl-12 pr-4 py-2 bg-[#0a0a0a] border border-white/10 rounded-xl text-white text-sm focus:outline-hidden focus:border-primary/50"
