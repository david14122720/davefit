        ...
        <div className="relative w-full max-w-4xl mx-auto flex-1 flex flex-col justify-center gap-6">
          ...
          <div className="grid grid-cols-2 gap-4">
             <div className="bg-[#141414]/80 backdrop-blur-3xl p-6 rounded-xl border border-white/5 flex flex-col items-center justify-center gap-1 group overflow-hidden relative">
                <div className="absolute -right-2 -top-2 w-16 h-16 bg-white/5 rounded-full blur-2xl group-hover:bg-primary/10 transition-colors"/>
          ...
          {/* Rest Indicator */}
          <div className="w-full h-12 bg-primary/5 rounded-2xl border border-primary/20 flex items-center justify-between px-6">
             <span className="text-[10px] font-black text-primary/70 uppercase tracking-widest">Descanso Estratégico</span>
             <span className="text-lg font-black text-primary">{currentEjercicio.descanso_segundos}s</span>
          </div>
        </div>
      </main>
         ...
         <div className="max-w-md mx-auto grid grid-cols-5 items-center gap-4">
            ...
            <div className="col-span-1 flex flex-col items-center gap-1">
               <div className="w-16 h-16 rounded-2xl bg-white/5 border border-white/5 flex items-center justify-center">
                  <span className="text-lg font-black text-primary">{completedExercises.size}</span>
               </div>
        ...
        {showInstructions && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} onClick={() => setShowInstructions(false)} className="fixed inset-0 z-100 bg-black/90 backdrop-blur-2xl flex items-end p-0">
             ...
             >
                ...
                <h3 className="text-xs font-black text-primary uppercase tracking-[0.3em] mb-6">Guía de Operación</h3>
              ...
              {xpResult && (
                <div className="flex justify-center gap-4 mb-12">
                   <div className="px-6 py-3 bg-white/5 border border-white/5 rounded-2xl">
                      ...
                      <span className="text-2xl font-black text-primary">+{xpResult.xp_ganado}</span>
                   </div>
                   <div className="px-6 py-3 bg-white/5 border border-white/5 rounded-2xl">
